...
public class Personne {
    ...
    public void printListOfContacts(){
       ...
       for(int i=0; i<listeDesContact.size();i++)
       {
           ...
           System.out.println("*adresse:         "+listeDesContact.get(i).adresse.getCompleteAdresse());
    ...
    public void setAdresse(Adresse x){
        this.adresse.setNumero(x.getNumero());
        this.adresse.setRue(x.getRue());
        this.adresse.setCp(x.getCp());
        this.adresse.setVille(x.getVille());
    }
